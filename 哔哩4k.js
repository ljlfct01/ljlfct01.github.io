...
var rule = {
    ...
    timeout:5000,
    class_name:'五岳｜️️4K番剧&五岳｜️️4K国创&五岳｜️️4K电影&五岳｜️️4K电视剧&五岳｜️️4K纪录片&五岳｜️️4K综艺&五岳｜️️4K全部&五岳｜️️4K追番&五岳｜️️4K追剧&五岳｜️️4K时表表',
    ...
    lazy:`js:
        if (/^http/.test(input)) {
            ...
            if (jRoot["message"] !== "success") {
                ...
                result["parse"] = 0;
                result["playUrl"] = "http://kcjx.zwzs.fun/json.php?url=";
                result["url"] = url;
                result["header"] = {
                    Referer: "https://www.bilibili.com",
