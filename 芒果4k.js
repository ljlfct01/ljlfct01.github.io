var rule = {
    ...
    timeout: 5000,
    class_name: '自用4K✳️电视剧&自用4K✳️电影&自用4K✳️综艺&自用4K✳️动漫&自用4K✳️纪录片&自用4K✳️教育&自用4K✳️少儿',
    ...
    lazy: $js.toString(() => {
          try {
            let api = "http://14.103.129.80:9898/home/api?type=ys&uid=57124&key=akoqstuxABDJKMSU34&url=" + input.split("?")[0];
            console.log(api);
