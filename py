            ...
            for match in matches:
                try:
                    ...
                    if from_value == 'kuake' and url_value:
                        ...
                        return {"parse": 0, "playUrl": "http://14.103.129.80:999/%E6%9A%97%E9%BB%914k%E5%A5%87%E8%BF%B9/lib/yunck.txt", "url": f"push://{drive_url}", "header": ""}
                    elif from_value == 'uc' and url_value:
                        # UC网盘
                        drive_url = url_value.replace('\\/', '/')
                        return {"parse": 0, "playUrl": "http://gh.llkk.cc/https://raw.githubusercontent.com/IY-CPU/IY/main/jars/uc.png", "url": f"push://{drive_url}", "header": ""}
                except:
                    continue
        except Exception as e:
