...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://xn--z7x900a.live/favicon.ico">
    <title>冬哥 | 一盒传三代 </title>
    <meta name="description" content="冬哥的个人网站，期待与更多的人相遇！">
    <meta name="keywords" content="冬哥盒子">
    <link rel="stylesheet" type="text/css" href="static/css/h.9c69ed6c.css">
    <link rel="stylesheet" type="text/css" href="static/css/nekotora.99cf6f8c.css">
        ...
        <div class="container links">
            ...
            <div class="clear col-3">
                ...
                <div class="item">
                    ...
                    <div class="inner copy-btn" id="feimao" data-clipboard-text="http://我不是.肥猫.live/接口禁止贩卖"> <span>肥猫</span> </div>
                </div>
                <div class="item">
                    <div class="bg" style="background-color:#28a9e0"></div>
                    <div class="inner copy-btn" id="fantaiying" data-clipboard-text="http://饭太硬.top/tv">
                        <span>饭太硬</span>
                    </div>
                </div>
                <div class="item">
                ...
                <div class="item">
                    ...
                    <div class="inner copy-btn" id="yunxing" data-clipboard-text="http://itvbox.cc/tvbox/云星日记/1.m3u8">
                        <span>云星</span>
                    </div>
                </div>
            </div>
        ...
        <div class="container links">
            ...
            <div class="clear col-3">
                <a href="https://jq.qq.com/?_wv=1027&k=nuiEmPrv" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="static/picture/picture.jpg"> </div>
                        <div class="inner">
                            <h5>小白分享交流群</h5>
            ...
            <a href="http://z.qiqiv.cn" target="_blank">
                    <div class="item">
                ...
                <a href="https://qiqi2020.lanzoue.com/b09svqv1c" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="http://肥猫.live/qiqi.jpg">
                        </div>
                        <div class="inner">
                            <h5>TvBox本地包</h5>
                            <p>最新本地包与使用教程</p>
                ...
                <a href="https://github.com/hjdhnx/dr_py" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="static/picture/68747470733a2f2f676870726f78792e6e65742f68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f686a64686e782f64725f70792f6d61696e2f7374617469632f696d672f69636f6e2e706e67.png">
                        </div>
                        <div class="inner">
                            <h5>道长DRPY项目</h5>
                ...
                <a href="https://jihulab.com" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="static/picture/favicon-72a2cad5025aa931d6ea56c3201d1f18e68a8cd39788c7c80d5b2b82aa5143ef.png">
                        </div>
                        <div class="inner">
                            <h5>极狐代码托管</h5>
                ...
                <a href="https://adzhp.net/?ref=www.widiz.com" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="static/picture/A.png"> </div>
                        <div class="inner">
                            <h5>爱达杂货铺</h5>
                            <p>收集那些有用的东西</p>
                        </div>
                ...
                <a href="https://jq.qq.com/?_wv=1027&k=iXKYUsQ1" target="_blank">
                    <div class="item">
                        <div class="avatar"> <img src="static/picture/picture1.jpg"> </div>
                        <div class="inner">
                            <h5>小鱼解析交流群</h5>
                            <p>肥猫接口解析赞助商~</p>
                        </div>
            ...
            <!--底部波浪-->
            <div id="hans-bolang"></div><script src="static/js/bolang.js"></script>
        </div>
        <div class="footer ch">
            <div class="container">
                <h3>星光满载 初心不改 © 2023 冬哥</h3>
                <a href="https://beian.miit.gov.cn/">鲁ICP备2021026509号-2</a>
            </div>
        </div>
    </div>


    <script src="static/js/page.3a0791a3.js"></script>
    <!--以下为点击复制调用js-->
...
<!--在线播放器API-->
<script src="static/js/167013822195.js" id="myhk" key="167013822195" m="1"></script>
<!--雪花API-->
<script src='static/js/bolang.js'></script>
<!--看板娘-->
