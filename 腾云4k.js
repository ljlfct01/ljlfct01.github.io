...
var rule = {
    ...
    class_name: '自用4K✳️电影&自用4K✳️电视剧&自用4K✳️综艺&自用4K✳️动漫&自用4K✳️少儿&自用4K✳️纪录片',
    ...
    lazy: $js.toString(() => {
        try {
            let api = "http://14.103.129.80:9898/home/api?type=ys&uid=57124&key=dfkmptwDHLOPZ13489&url=" + input.split("?")[0];
            console.log(api);
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "qq" : "自用$$$qq 预告及花絮";
