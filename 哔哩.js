var rule = {
    ...
    headers: {
        ...
        "Cookie": "SESSDATA=7624af93%2C1696008331%2C862c8%2A42; bili_jct=141a474ef3ce8cf2fedf384e68f6625d; DedeUserID=3493271303096985; DedeUserID__ckMd5=212a836c164605b7" // Cookie 文件地址
    },
    ...
    一级: `js:
        ...
        function get_timeline(tid, pg) {
            let videos = [];
            let url = "http://sspa8.top:8100/api/?key=%E6%99%93%E5%AE%87&url=" + tid + "&day_before=2&day_after=4";
            let html = request(url); // 发起请求
            let jo = JSON.parse(html); // 解析返回的 JSON
